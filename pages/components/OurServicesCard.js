    ...
    return (
        <Paper sx={{ p: 3 ,border: "1px solid #EAF0F5",borderRadius:"26px" }} elevation={0} >
            <Stack direction="column"  spacing={2}>
                ...
                <Typography variant="body1" fontWeight={"bold"} fontSize={20} color="#2A6498">{title}</Typography>
                <Typography variant="body1" fontSize={16} color="#AAAAAA">{description}</Typography>
